...
Compiler.prototype.outputInterruptTest = function () { // Added by RNL
    ...
    if (Sk.execLimit !== null || Sk.yieldLimit !== null && this.u.canSuspend) {
        output += "var $dateNow = Sk.global.Date_now();";
...
Compiler.prototype.outputSuspensionHelpers = function (unit) {
    ...
    var output = (localsToSave.length > 0 ? ("var " + localsToSave.join(",") + ";") : "") +
                 "var $wakeFromSuspension = function() {" +
                    ...
                    "$currLineNo=susp.$lineno; $currColNo=susp.$colno; Sk.lastYield=Sk.global.Date_now();" +
...
Compiler.prototype.buildcodeobj = function (n, coname, decorator_list, args, callback, class_for_super) {
    ...
    if (Sk.execLimit !== null) {
        this.u.varDeclsCode += "if (typeof Sk.execStart === 'undefined') {Sk.execStart = Sk.global.Date_now()}";
    }
    if (Sk.yieldLimit !== null && this.u.canSuspend) {
        this.u.varDeclsCode += "if (typeof Sk.lastYield === 'undefined') {Sk.lastYield = Sk.global.Date_now()}";
    }
...
Compiler.prototype.cclass = function (s) {
    ...
    if (Sk.execLimit !== null) {
        this.u.switchCode += "if (typeof Sk.execStart === 'undefined') {Sk.execStart = Sk.global.Date_now()}";
    }
    if (Sk.yieldLimit !== null && this.u.canSuspend) {
        this.u.switchCode += "if (typeof Sk.lastYield === 'undefined') {Sk.lastYield = Sk.global.Date_now()}";
    }
